...
namespace Owin.Security.Providers.MercadoLibre
{
    ...
    public class MercadoLibreAuthenticatedContext : BaseContext
    {
        ...
        public MercadoLibreAuthenticatedContext(IOwinContext context, JObject user, string accessToken)
            : base(context)
        {
            User = user;
        ...
        /// </summary>
        /// <remarks>
        /// Contains the MercadoLibre user obtained from the User Info endpoint. By default this is https://api.mercadolibre.com/users", but it can be
