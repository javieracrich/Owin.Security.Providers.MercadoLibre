    ...
    public class MercadoLibreAuthenticationHandler : AuthenticationHandler<MercadoLibreAuthenticationOptions>
    {
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                var context = new MercadoLibreAuthenticatedContext(Context, user, accessToken)
                {
                ...
                {
                    context.Identity.AddClaim(new Claim("urn:MercadoLibre:name", context.Name, XmlSchemaString, Options.AuthenticationType));
                }
                if (!string.IsNullOrEmpty(context.Link))
                {
                    context.Identity.AddClaim(new Claim("urn:MercadoLibre:url", context.Link, XmlSchemaString, Options.AuthenticationType));
                }
