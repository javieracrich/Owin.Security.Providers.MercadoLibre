...
namespace Owin.Security.Providers.MercadoLibre
{
    public class MercadoLibreAuthenticationMiddleware : AuthenticationMiddleware<MercadoLibreAuthenticationOptions>
    {
        ...
        public MercadoLibreAuthenticationMiddleware(OwinMiddleware next, IAppBuilder app,
            ...
            : base(next, options)
        {
            ...
            if (Options.StateDataFormat == null)
            {
                var dataProtector = app.CreateDataProtector(
                    typeof (MercadoLibreAuthenticationMiddleware).FullName,
            ...
            _httpClient.DefaultRequestHeaders.UserAgent.ParseAdd("Microsoft Owin MercadoLibre middleware");
        ...
        ///     <see cref="T:Owin.Security.Providers.MercadoLibre.MercadoLibreAuthenticationOptions" /> supplied to the constructor.
        /// </returns>
